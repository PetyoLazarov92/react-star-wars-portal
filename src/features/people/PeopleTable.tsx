        ...
        <tbody>
          {people.map((person) => (
            <tr key={person.name} className="border-b border-slate-200 dark:border-slate-800">
              ...
              <td className="px-3 py-2 text-slate-900 dark:text-slate-100">{person.mass}</td>
              <td className="px-3 py-2 text-slate-900 dark:text-slate-100">{person.height}</td>
              <td className="px-3 py-2 text-slate-900 dark:text-slate-100">{person.hair_color}</td>
              <td className="px-3 py-2 text-slate-900 dark:text-slate-100">{person.skin_color}</td>
            </tr>
          ))}
        </tbody>
      </table>
